...
\x1b[1;96m========================================
\x1b[1;91m[TOOLS     >   𝑲𝑮𝑭 𝑻𝑬𝑴 ✓]
\x1b[1;92m[MAKING    >    𝑫𝒆𝒄𝒐𝒅𝒆 𝑻𝒐𝒐𝒍𝒔 𝒏𝒐𝒕 𝒐𝒘𝒏𝒆𝒓 𝒏𝒂𝒎𝒆 ]
\x1b[1;93m[CODING    =    FUK ]
\x1b[1;94m[THIS TOOL DECODE BY : https://t.me/KGF_TERMUX_TEAM ]
\x1b[1;97m========================================"""
...
def main():
    ...
    linex()
    print(f'{y} [√]EXAMPLE >>👉 @𝗞𝗚𝗙_𝗧𝗘𝗠_1823👈{w}')
    linex()
